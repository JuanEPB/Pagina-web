...
<header>
    <div class="logo" >
        <div class="imagelogo">
        <img src="./img/logo.png" width="300px" height="" alt="Logo de la empresa">
        </div>
            ...
            <div class="col-md-4">
                <div class="card card-hover" style="border-radius: 15px;">
                    <div class="card-body text-center">
                        ...
                        <h4 class="mb-2">Greet Alejandra Vallejo Iniesta</h4>
                        <p class="text-muted mb-4">Ing. Mecatronico</p>
                        <div class="mb-4 pb-2">
                        ...
                        <div class="mt-3 mb-4">
                            <img src="./img/qr-code.png" class="img-fluid" style="min-width: 80%; " />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row text-center margin-left-100px">
    <div class="col-6 h-100">
        <p>
            <button class="btn d-flex flex-column justify-content-center align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#Mision" aria-expanded="false" aria-controls="Mision" style="min-width: 80%; margin-right:100px;">
                <img src="./img/mision.png" style="width: 50px; height: 50px;">
                <span>Misión</span>
            </button>
        </p>
        <div style="min-height: 120px;">
            <div class="collapse collapse-horizontal" id="Mision">
                <div class="card card-body" style="width: 700px;">
                    MISIÓN: Ser una empresa de confianza en proporcionar soluciones en sistemas de aire comprimido, así como en proyectos integrales para la industria, basado en un modelo integral de calidad, contribuyendo a la rentabilidad de cada uno de nuestros clientes.
                </div>
            </div>
        </div>
    </div>
    <div class="col-6 h-100">
        <p>
            <button class="btn  d-flex flex-column justify-content-center align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#Vision" aria-expanded="false" aria-controls="Vision" style="min-width: 80%; margin-right:100px;">
                <img src="./img/vision.png" style="width: 50px; height: 50px;">
                <span>Visión</span>
            </button>
        </p>
        <div style="min-height: 120px;">
            <div class="collapse collapse-horizontal" id="Vision">
                <div class="card card-body" style="width: 700px;">
                    VISIÓN: Ser una compañía líder y confiable en sistemas de aire comprimido, garantizando a los clientes ser un aliado estratégico para todos los requerimientos neumáticos que demanda la industria, brindando asesorías a sus necesidades reales y lograr en conjunto, que sus sistemas estén en su eficiencia óptima, con un personal comprometido y alineado a los valores organizacionales, contribuyendo a la rentabilidad de cada uno de los clientes.
                </div>
            </div>
        </div>
    </div>
