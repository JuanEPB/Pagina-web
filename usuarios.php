...
<div class="card-header">
        ...
        Usuarios     <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#userForm">Nuevo Usuario <i class="bi bi-box"></i></button>
    </div>
    <div class="card-body">
        ...
        <tbody id="data">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a href="edit_user.php?id=<?= htmlspecialchars($datos->id)?>" class="btn btn-warning">Editar<i class="bi bi-pen"></i></a>
                    <button class="btn btn-danger" onclick="location.href='delete_user.php?id=<?= htmlspecialchars($datos->id)?>'">Borrar<i class="bi bi-trash"></i></button>                    </td>
                </tr>
            <?php
            }
            ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="row">
                    ...
                    <div class="text-center">
                        <button class="btn btn-success" id="saveButton" onclick="location.href='add_user.php?'">Guardar</button>
                        <button class="btn btn-danger" id="cancelButton" onclick="location.href='usuarios.php'">Cancelar</button>
                    </div>
        </div>
                </form>
            </div>
